...
export const BUILT_IN_FAMILIES: RoleFamily[] = [
  ...
  { id: "evidence", domainId: "core", name: "Evidence", nameCN: "证据", description: "Fact verification, evidence quality, uncertainty labeling", tags: ["evidence", "fact_check", "verification"], enabledByDefault: true },
  { id: "scribe", domainId: "core", name: "Scribe", nameCN: "书记", description: "Decision recording, action item tracking, outcome capture", tags: ["decision", "recording", "action_items"], enabledByDefault: true },
  ...
  { id: "interaction", domainId: "design", name: "Interaction Design", nameCN: "交互设计", description: "State flows, controls, information hierarchy", tags: ["interaction", "design", "states", "controls"], enabledByDefault: true },
  ...
  { id: "analysis", domainId: "product_strategy", name: "Analysis", nameCN: "分析", description: "Signal analysis, risk assessment, second-order effects", tags: ["signal", "risk", "analysis", "impact"], enabledByDefault: true },
  ...
  { id: "synthesis", domainId: "research_writing", name: "Knowledge Synthesis", nameCN: "知识综合", description: "Cross-session synthesis, concept frameworks, note seeds", tags: ["synthesis", "knowledge", "frameworks", "patterns"], enabledByDefault: false },
];
